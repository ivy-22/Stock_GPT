...
def insertintotable():
    ...
    def get_historical(quote):
        ...
        df.to_csv(''+quote+'.csv')
        if(df.empty):
            ts = TimeSeries(key='jepAoBy5iTuWj4rSL22S6axJp27sHCEafeFF6Ebb',output_format='pandas')
    ...
    try:
        ...
        polarity, tw_list, tw_pol, pos, neg, neutral = 0, [], "Invest for the long haul. Don't get too greedy and don't get too scared.", 0, 0, 0
